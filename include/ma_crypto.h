...
/**
  @brief initialize crypto subsystem.
         This function must be called once before using crypto and
         hash function. The allocated memory must be released by
         ma_crypt_deinit()
...
/**
  @brief deinitialize crypto subsystem.
         This function must be called before shutting down server to
         release memory which was acquired by ma_crypt_init()
*/
